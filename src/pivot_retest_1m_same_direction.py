...
- results/pivot_retest_1m_same_direction/events_<MONTH>.csv
- results/pivot_retest_1m_same_direction/summary_<MONTH>.csv
- results/pivot_retest_1m_same_direction/hourly_stats_<MONTH>.csv
"""
...
RUN_TAG = "pivot_retest_1m_same_direction"
...
if not strong.empty:
    ...
    for i, (ts, row) in enumerate(strong.iterrows(), 1):
        ...
        # Minute window: first 20 minutes of next hour
